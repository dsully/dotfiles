...
# https://github.com/fish-shell/fish-shell/issues/8040
...
function __git_showuntracked
    if test (__fish_git config --get status.showuntrackedfiles; or echo "") = no
	return 1
    end
end 

complete -f -c git -n '__fish_git_using_command add; and __git_showuntracked' -a '(__fish_git_files modified untracked deleted unmerged)'
complete -f -c git -n '__fish_git_using_command add; and not __git_showuntracked' -a '(__fish_git_files modified deleted unmerged)'
